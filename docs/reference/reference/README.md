...
## Better CAS Environment Integration

{% hint style="success" %}
You can [_Send Pictures_](https://aarens-base.gitbook.io/better-cas-environment-doc/descriptions/ctab-compatibility/take-pictures-with-atak) via this Entension. :sunglasses:
{% endhint %}

{% content-ref url="better-cas-environment-integration.md" %}
